...
**YOU ARE IN: `todo_app/polecats/slit/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/todo_app/` (rig root) or other directories
...
**Your mail address:** `todo_app/polecats/slit`
**Your rig:** todo_app
**Your Witness:** `todo_app/witness`
...
| Ask Witness for help | `gt mail send todo_app/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`todo_app/witness`) when:
...
```bash
gt mail send todo_app/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
